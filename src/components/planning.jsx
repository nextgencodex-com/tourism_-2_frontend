...
export default function PlanningTripPage() {
  ...
  useEffect(() => {
    const dynamicBestSelling = getBestSellingPackages(6);
    setBestSellingPackages(dynamicBestSelling || []);
                    ...
                    <div className="p-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <button
                          ...
                          onClick={() =>
                            openWhatsApp(`Hello, I am contacting you via the website about the package: ${pkg.title || 'Tour Package'}.`)
                          }
                        >
